...
eyeBack.innerHTML = "<";
eyeFor.innerHTML = ">";
eyebrowBack.innerHTML = "<";
eyebrowFor.innerHTML = ">";
...
const eyeMaskLoad = () => {
  ...
  eyeInfo.innerHTML = eyeInfoContent[chooseEyes.value - 1];
  newSkinPreview();
};

const eyebrowMaskLoad = () => {
  eyebrowPreview.style.maskImage = 'url("eyebrows/' + String(chooseEyebrows.value) + '.png")';
  eyebrowInfo.innerHTML = eyebrowInfoContent[chooseEyebrows.value - 1];
  newSkinPreview();
};
